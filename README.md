<h1>A simple Book Store web app with CRUD operations where user can view the available books, add book of their choice, update any book & delete any book they want.</h1>
